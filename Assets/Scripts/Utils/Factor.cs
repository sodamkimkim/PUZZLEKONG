...
public class Factor:MonoBehaviour
{
    ...
    public static Vector3 PosGridSpawn { get => new Vector3(0f, 1f, 0f); }

    public static Vector3 PosPuzzleSpawn0 { get => new Vector3(-1.5f, -3.22f, -1f); }
    public static Vector3 PosPuzzleSpawn1 { get => new Vector3(0f, -3.22f, -1f); }
    public static Vector3 PosPuzzleSpawn2 { get => new Vector3(1.5f, -3.22f, -1f); }
